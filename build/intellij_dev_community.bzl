...
intellij_dev_binary_community = macro(
    ...
    attrs = {
        ...
        "config_path": attr.string(configurable = False, doc = "Path for -Didea.config.path. Defaults to out/dev-data/{name}/config, under the out/dev-data link."),
        "system_path": attr.string(configurable = False, doc = "Path for -Didea.system.path. Defaults to out/dev-data/{name}/system, under the out/dev-data link."),
